...
**Remaining backlog:** LDAdminDashboard shell (1,049: onboarding overlay + handlers) if further reduction wanted · ApiService→typed-hooks call-site migration · legacy group-login removal after first prod onboarding · production deploy (owner's hosting)
