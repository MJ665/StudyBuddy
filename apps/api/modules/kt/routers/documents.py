...
# modules/kt/routers/{doc_registry,doc_lifecycle,doc_actions,doc_assets}.py
from fastapi import APIRouter

from modules.kt.routers import doc_registry
from modules.kt.routers import doc_lifecycle
from modules.kt.routers import doc_actions
...
router.include_router(doc_actions.router)
