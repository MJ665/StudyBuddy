...
# modules/reporting/routers/{batch_reports,cohort_analytics,cohort_comparative}.py
from fastapi import APIRouter

from modules.reporting.routers import batch_reports
from modules.reporting.routers import cohort_analytics
from modules.reporting.routers import cohort_comparative
...
router.include_router(cohort_comparative.router)
